...
def resolvi_cluster(
    ...
    **model_kwargs,
    ...
    adata_train = adata.copy()
    scvi.external.RESOLVI.setup_anndata(adata_train, layer="raw", batch_key="dataset_id")
    ...
    adata_train.layers["generated_expression"] = samples_corr.loc[
        "post_sample_q50", "px_rate"
    ]
