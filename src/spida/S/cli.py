...
def ingest_region_register_subparser(subparser):
    ...
    parser.add_argument('--prefix-name', type=str, default="default", help='Prefix for the keys in the spatialdata object (default: default)')
...
def run_segmentation_region_register_subparser(subparser): 
    ...
    run_parser = subparser.add_parser(
        'run',
        aliases=['run-segmentation-region'],
...
def run_proseg_alignment_register_subparser(subparser):
    ...
    align_parser.add_argument('--out-prefix-name',type=str,default='proseg_aligned',help='Output prefix name (default: proseg_aligned)')
