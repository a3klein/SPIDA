...
def ingest_region_register_subparser(subparser):
    ...
    parser.add_argument('--type', type=str, default="merscope", help='Type of the data to ingest (default: merscope)')
    ...
    parser.add_argument('--source', type=str, default="machine", help='Source of the data (default: machine)')
...
def load_segmentation_region_register_subparser(subparser):
    ...
    parser.add_argument('exp_name', type=str, help='Name of the experiment')
    parser.add_argument('reg_name', type=str, help='Name of the region')
    parser.add_argument('seg_dir', type=parse_path, help='Directory containing segmentation data')
...
def run_proseg_alignment_register_subparser(subparser):
    ...
    align_parser.add_argument('--seed_prefix_name',type=str,default='default',help='Seed prefix name (default: default)')
    align_parser.add_argument('--prefix_name',type=str,default='proseg',help='Prefix name (default: proseg)')
    align_parser.add_argument('--out_prefix_name',type=str,default='proseg_aligned',help='Output prefix name (default: proseg_aligned)')
    align_parser.add_argument('--input_dir',type=str,help='Directory containing the input data (default: uses PROCESSED_ROOT_PATH env var)')
    align_parser.add_argument('--seg_dir',type=str,help='Segmentation directory (default: uses SEGMENTATION_OUT_PATH env var)')
    ...
    align_parser.add_argument('--cell_column',type=str,default='cell_id',help='Cell column name (default: cell_id)')
    ...
    align_parser.add_argument('--cell_metadata_fname',type=str,default='merged_cell_metadata.csv',
                              help='Cell metadata filename (default: merged_cell_metadata.csv)')
    align_parser.add_argument('--cell_by_gene_fname',type=str,default='merged_cell_by_gene.csv',
                              help='Cell by gene filename (default: merged_cell_by_gene.csv)')
    align_parser.add_argument('--detected_transcripts_fname',type=str,default='merged_transcript_metadata.csv',
                              help='Detected transcripts filename (default: merged_transcript_metadata.csv)')
    align_parser.add_argument('--cell_polygons_fname',type=str,default='merged_cell_polygons.geojson',
