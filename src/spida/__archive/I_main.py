...
def backup_adata_region_register_subparser(subparser):
    ...
    parser.add_argument(
        ...
        type=parse_path,
        default=None,
        help="Path to the store of AnnData objects (default: None)",
    )
    return
...
def allcools_integration_region_register_subparser(subparser):
    ...
    parser.add_argument(
        ...
        type=parse_path,
        default=None,
        help="Path to the store of annotation specific files (default: None)",
    )
    parser.add_argument(
        "-k",
        "--kwargs",
...
def mmc_setup_register_subparser(subparser):
    ...
    parser.add_argument(
        "hierarchy_list",
        type=parse_list,
        help="List of hierarchy levels for the annotation",
    )
    parser.add_argument(
        "brain_region", type=str, help="Brain region for the annotation"
    )
    ...
    parser.add_argument(
        ...
        type=parse_path,
        default=None,
        help="Path to the codebook file (default: None)",
    )
    parser.add_argument(
        "--mmc-store-path",
        type=parse_path,
        default=None,
        help="Path to the store of MapMyCells markers (default: None)",
    )
    parser.add_argument(
        "--ref-norm",
        type=str,
        default="log2CPM",
        help="Normalization method for the reference AnnData.X (default: log2CPM)",
    )
    parser.add_argument(
        "-k",
        "--kwargs",
