...
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/CORTEX/logs/{EXP_N}/decon_{EXP_N}_{REG_N}_P.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/CORTEX/logs/{EXP_N}/decon_{EXP_N}_{REG_N}_P.out
#SBATCH --export=ALL
