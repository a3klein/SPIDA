...
#SBATCH -t 00:20:00
#SBATCH --nodes=1
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/CORTEX/logs/{EXP_N}/start_{EXP_N}_{REG_N}.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/CORTEX/logs/{EXP_N}/start_{EXP_N}_{REG_N}.out
