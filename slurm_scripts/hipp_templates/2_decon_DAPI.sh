...
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/HIPP/logs/{EXP_N}/decon_{EXP_N}_{REG_N}_D.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/HIPP/logs/{EXP_N}/decon_{EXP_N}_{REG_N}_D.out
#SBATCH --export=ALL
