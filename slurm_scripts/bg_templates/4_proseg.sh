...
#SBATCH --ntasks=128
#SBATCH --mem=128gb
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG/logs/{EXP_N}/proseg_{EXP_N}_{REG_N}.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG/logs/{EXP_N}/proseg_{EXP_N}_{REG_N}.out
#SBATCH --export=ALL
...
pixi run -e preprocessing \
    ...
    --output_dir /home/x-aklein2/projects/aklein/BICAN/data/segmented/{EXPERIMENT}/${{PREFIX}} \
    --kwargs \
    voxel-layers=7 \
    ncomponents=10 \
...
pixi run -e preprocessing \
    ...
    {EXPERIMENT} \
    {REGION} \
    /home/x-aklein2/projects/aklein/BICAN/data/segmented/{EXPERIMENT}/${{PREFIX}} \
    --type proseg \
    --prefix_name ${{PREFIX}} \
    --plot
