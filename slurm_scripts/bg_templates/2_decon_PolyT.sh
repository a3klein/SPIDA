...
#SBATCH --mem=256gb
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG_R/logs/{EXP_N}/2_decon_{EXP_N}_{REG_N}_P.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG_R/logs/{EXP_N}/2_decon_{EXP_N}_{REG_N}_P.out
