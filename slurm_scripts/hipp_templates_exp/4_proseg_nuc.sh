...
#SBATCH --ntasks=128
#SBATCH --mem=128gb
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/HIPP/logs/{EXP_N}/4b_proseg_nuc_{EXP_N}_{REG_N}.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/HIPP/logs/{EXP_N}/4b_proseg_nuc_{EXP_N}_{REG_N}.out
...
echo -e "\n\tRunning ProSeg Nuc on Region {REG_N} of Experiment {EXP_N} - ${{PREFIX}}\n"
# SEGMENTATION
