#!/bin/bash
# FILENAME = proseg_align.sh 

#SBATCH -A mcb130189
#SBATCH -J proseg_align_{EXP_N}_{REG_N}
#SBATCH -p wholenode
#SBATCH --time=1:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --mem=128gb
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/HIPP/logs/{EXP_N}/4c_proseg_align_{EXP_N}_{REG_N}.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/HIPP/logs/{EXP_N}/4c_proseg_align_{EXP_N}_{REG_N}.out
...
echo -e "\n\tRunning ProSeg Alignment on Region {REG_N} of Experiment {EXP_N} - ${{PREFIX}}\n"
# SEGMENTATION
pixi run --frozen -e preprocessing \
    ...
    {EXPERIMENT} \
    {REGION} \
    --input_dir {SEGMENTATION_DIR}/{EXPERIMENT}/cellpose_align/ \
