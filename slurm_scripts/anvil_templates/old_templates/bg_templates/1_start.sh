...
#SBATCH -t 00:40:00
#SBATCH --nodes=1
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG_R/logs/{EXP_N}/1_start_{EXP_N}_{REG_N}.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG_R/logs/{EXP_N}/1_start_{EXP_N}_{REG_N}.out
