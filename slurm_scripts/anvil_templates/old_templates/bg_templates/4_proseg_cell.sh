...
#SBATCH --ntasks=128
#SBATCH --mem=128gb
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG_R/logs/{EXP_N}/4a_proseg_cell_{EXP_N}_{REG_N}.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG_R/logs/{EXP_N}/4a_proseg_cell_{EXP_N}_{REG_N}.out
...
pixi run --frozen -e preprocessing \
    ...
    --seg_fam proseg \
    --plot \
    --cutoffs_path /home/x-aklein2/projects/aklein/BICAN/BG_R/config/filtering_cutoffs_proseg.json
