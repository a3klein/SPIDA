...
#SBATCH --ntasks=1
#SBATCH --mem=32gb
#SBATCH -o /home/x-aklein2/projects/aklein/BICAN/BG_R/logs/{EXP_N}/5_mmc_annot_{EXP_N}_{REG_N}.out
#SBATCH -e /home/x-aklein2/projects/aklein/BICAN/BG_R/logs/{EXP_N}/5_mmc_annot_{EXP_N}_{REG_N}.out
...
pixi run --frozen -e mmc \
    ...
    BG-AIT-ref-full \
    --suffix _filt \
    --mmc_store_path /home/x-aklein2/projects/aklein/BICAN/BG_R/data/mmc \
    --plot_name mmc_annot_BG_AIT_full \
    --n_cpu 8 \
    --bootstrap_factor 0.9 \
    --bootstrap_iterations 500 \
    --plot \
    --filter_annotations \
    --palette_path /home/x-aklein2/projects/aklein/BICAN/BG_R/data/reference/color_palette.json \
    --l1_thr=0.75 \
    --l2_thr=0.75 \
    --l3_thr=0.75 \
    --l4_thr=0.6 \
...
pixi run --frozen -e mmc \
    ...
    --suffix _filt \
    --mmc_store_path /home/x-aklein2/projects/aklein/BICAN/BG_R/data/mmc \
    --plot_name mmc_annot_BG_AIT_filtered \
    --n_cpu 8 \
    --bootstrap_factor 0.9 \
    --bootstrap_iterations 500 \
    --plot \
